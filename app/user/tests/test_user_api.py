...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'goti@gmail.com',
                   'password': 'testpass', 'name': 'goti'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@gmail.com', 'password': 'pw', 'name': 'goti'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token is not created if invaid credentials are given"""
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(email='goti@gmail.com',
